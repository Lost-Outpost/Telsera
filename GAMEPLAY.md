...
On your journey through the Eldryn version of Skyrim, you will find a performance-friendly yet visually stunning environment, with thoughtfully curated, integrated, and balanced additions. As you explore this expanded yet familiar Skyrim world, you will discover plenty of high-quality and fun experiences.

This guide highlights major mods included in Eldryn in the following categories:
...
- :ledger: indicates Eldryn configuration notes
- :video_game: indicates Eldryn play testing observations
...
Eldryn is built around the [Simon Magus (SimonRim)](https://www.nexusmods.com/skyrimspecialedition/users/67410746?tab=user+files) gameplay overhaul. SimonRim remasters various systems in Skyrim in a cohesive way that stays true to the original while improving the balance and gameplay. The included SimonRim list:
...
- [Blade and Blunt](https://www.nexusmods.com/skyrimspecialedition/mods/34549) - A lightweight combat enhancement that makes combat more engaging.
...
- [Mysticism](https://www.nexusmods.com/skyrimspecialedition/mods/27839) - A magic overhaul that fixes balance issues and introduces new spells.

- [Thamaturgy](https://www.nexusmods.com/skyrimspecialedition/mods/57138) - An enchanting overhaul that fixes some major issues with enchanting balance.

In addition to SimonRim, this list includes:

- [Sacrilege](https://www.nexusmods.com/skyrimspecialedition/mods/42408) - Sacrilege is a high-depth, low-complexity vampire mod. It is a cleaned-up and slimmed-down version of Sacrosanct, offering an in-depth vampire experience without feature bloat.
...
Eldryn includes a minimalistic and modern UI, featuring:
...
- [Cloaks of Skyrim](https://www.nexusmods.com/skyrimspecialedition/mods/6369) - Adds almost 100 new styles of cloak to the world of Skyrim, via crafting, leveled lists, and static loot. They are lore-friendly and enchantable, and more are being added with every update. The aim of this mod is to provide some variety and flavor to the world, as well as the chance to wear a stylish cloak and quite literally keep the cold out.
...
- [Inigo](https://www.nexusmods.com/skyrimspecialedition/mods/1461) - Inigo is a fully voiced khajiit adventuring companion with over 7000 lines of unique dialogue - much of it about you. He'll level alongside you and avoid most traps. If you're sneaking he won't chatter and he'll whisper if you talk to him. He can run out of arrows. He's highly skilled in archery, one-handed, and sneak.
  ...
  > :video_game: You can find Inigo in Riften's jail.
...
- [Clockwork](https://www.nexusmods.com/skyrimspecialedition/mods/4155) - Clockwork is a quest mod involving a castle high in the Velothi Mountains, lost to the world for over a hundred years. Once found, you may call Clockwork Castle home... but if you want to leave, you'll need to discover how to escape.
  ...
  > :video_game: To begin, you must be at least level 13, then when you are within the general worldspace of Tamriel, you will be ambushed.
